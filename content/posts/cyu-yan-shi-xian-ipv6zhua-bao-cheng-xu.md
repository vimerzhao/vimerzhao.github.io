...
关于代码实现，可以查看`/usr/include/netinet`目录下的头文件，比如说`icmp6.h`下就记录了ICMPv6协议的格式：
...
![](http://ond7j4cnz.bkt.clouddn.com/blog2017-04-19%2011-35-53%E5%B1%8F%E5%B9%95%E6%88%AA%E5%9B%BE.png)
...
然后在浏览器打开一个窗口，如[http://test-ipv6.com/](http://test-ipv6.com/)。便可以抓到数据包，由于数据较多，选取一段：
```
